...
| **AI extraction inaccuracies** | AI model produced inconsistent outputs when extracting structured accident data from police report PDFs, affecting **AI-driven vehicle damage analysis visualization and Clio CRM synchronization**. | Designed a structured **multi-step prompt with validation rules** tailored to the NY MV-104AN form and iteratively tested across multiple cases. | Improved extraction reliability and ensured accurate accident visualization and consistent data synchronization with Clio. |
